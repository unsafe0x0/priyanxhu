    ...
    <div className="prose prose-invert max-w-none w-full min-w-0 overflow-hidden">
      <ReactMarkdown
        ...
        components={{
          ...
          blockquote: ({ children }) => (
            <blockquote className="border-l-4 border-red-500 bg-[#202020] pl-4 py-2 my-6 rounded-r-lg">
          ...
          table: ({ children }) => (
            <div className="my-5 w-full max-w-full">
              <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-neutral-600 scrollbar-track-transparent max-w-[calc(100vw-2rem)] sm:max-w-[calc(100vw-4rem)] lg:max-w-[850px]">
                <table className="border-collapse bg-[#202020] w-auto min-w-full rounded-md border border-[#282828]">
                  {children}
                </table>
              </div>
            </div>
          ...
          a: ({ href, children }) => (
            <a
              href={href}
              className="text-red-400 hover:text-red-300 underline transition-colors duration-200 break-all overflow-wrap-anywhere"
              target="_blank"

      ...
      <div className="flex flex-col justify-start items-start w-full px-3 md:w-3xl gap-7">
        ...
        <div className="columns-1 gap-5 w-full space-y-5">
          {projects.map((project, index) => (
            <div
              key={index}
              className="flex flex-col justify-start items-start gap-2 border border-neutral-200 dark:border-neutral-700/50 rounded-md p-5 bg-neutral-50 dark:bg-neutral-900 break-inside-avoid"
            >

...
export default function BlogsPage() {
  ...
  const allTags = useMemo(() => {
    ...
    blogsData.forEach((blog) => blog.tags.forEach((tag) => tags.add(tag)));
      ...
      <section className="space-y-6 mb-12">
        <div className="space-y-4">
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-white leading-[1.1]">
            Writing about
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#c15f3c] to-orange-400">
              code & systems
            </span>
          </h1>
